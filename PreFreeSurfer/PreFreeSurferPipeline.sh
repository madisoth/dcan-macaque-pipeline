...
if ${useIntermediateReg}; then
  ...
  --ref2mmmask=${Template2mmMask} \
  --intowarp=${AtlasSpaceFolder}/xfms/acpc_dc2int.nii.gz \
  --intoinvwarp=${AtlasSpaceFolder}/xfms/int2acpc_dc.nii.gz \
  --int2refowarp=${AtlasSpaceFolder}/xfms/int2standard.nii.gz \
  --int2refoinvwarp=${AtlasSpaceFolder}/xfms/standard2int.nii.gz \
